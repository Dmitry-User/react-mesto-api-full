...
// const jwt = require('jsonwebtoken');
const YOUR_JWT = JWT_SECRET; // вставьте сюда JWT, который вернул публичный сервер
const SECRET_KEY_DEV = DEV_SECRET; // вставьте сюда секретный ключ для разработки из кода
try {
